...
int setChannelConfig(odrive_endpoint *endpoint, Json::Value odrive_json, Json::Value config_json, bool save_config);
...
extern int getObjectByName(Json::Value odrive_json, std::string name, odrive_object *odo);
